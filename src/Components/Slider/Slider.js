  ...
  return (
    <div>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <div className="caption-content">
              <h1>Plant a tree today; it will help us breathe tomorrow</h1>
              <p> Trees provide us with oxygen and fresh air and planting them will ensure we have fresh air to breathe in the future.</p>
              <a href="/about">
      <button>About Us</button>
        ...
        <Carousel.Item>
          <img style={{ height: '90vh' }} className="d-block w-100" src="https://ecoyaan.com/images/carousel-2.png" alt="Third slide" />
          <Carousel.Caption>
            <div className="caption-content-2">
              <h1 style={{color:'black'}}>Follow us on Instagram</h1>
              <p style={{color:'black'}}>For climate news, lifestyle tips, & updates</p>
